<?php
/* Smarty version 4.3.0, created on 2023-04-16 15:59:09
  from 'E:\MINE\site\app\View\admin\home\home.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_643baacd9cf4d1_68817330',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2e160e4a666419aa4a11081ce39c0562acdf3049' => 
    array (
      0 => 'E:\\MINE\\site\\app\\View\\admin\\home\\home.tpl',
      1 => 1681631945,
      2 => 'file',
    ),
  ),
...
function content_643baacd9cf4d1_68817330 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container ace-save-state" id="main-container">
 ...
 type="text/javascript">
        try<?php echo (defined('LEFT_DELIM') ? constant('LEFT_DELIM') : null);?>
ace.settings.loadState('main-container')<?php echo (defined('RIGHT_DELIM') ? constant('RIGHT_DELIM') : null);?>
catch(e){}
    <?php echo '</script'; ?>
>
 ...
 type="text/javascript">
            try<?php echo (defined('LEFT_DELIM') ? constant('LEFT_DELIM') : null);?>
ace.settings.loadState('sidebar')<?php echo (defined('RIGHT_DELIM') ? constant('RIGHT_DELIM') : null);?>
catch(e){}
        <?php echo '</script'; ?>
>
...
<!--[if !IE]> -->
<?php echo '<script'; ?>
 src="assets/js/jquery-2.1.4.min.js"><?php echo '</script'; ?>
>
...
<!--[if IE]>
<?php echo '<script'; ?>
 src="assets/js/jquery-1.11.3.min.js"><?php echo '</script'; ?>
>
<![endif]-->
<?php echo '<script'; ?>
 type="text/javascript">
...
<![endif]-->
<?php echo '<script'; ?>
 src="assets/js/jquery-ui.custom.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/js/jquery.ui.touch-punch.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/js/jquery.easypiechart.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/js/jquery.sparkline.index.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/js/jquery.flot.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="assets/js/jquery.flot.pie.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 ...
 type="text/javascript">
    jQuery(function($) {
        $('.easy-pie-chart.percentage').each(function(){
            ...
            $(this).easyPieChart(<?php echo (defined('LEFT_DELIM') ? constant('LEFT_DELIM') : null);?>
                ...
                size: size
            <?php echo (defined('RIGHT_DELIM') ? constant('RIGHT_DELIM') : null);?>
);
        <?php echo (defined('RIGHT_DELIM') ? constant('RIGHT_DELIM') : null);?>
)
        ...
        var placeholder = $('#piechart-placeholder').css(<?php echo (defined('LEFT_DELIM') ? constant('LEFT_DELIM') : null);?>
'width':'90%' , 'min-height':'150px'<?php echo (defined('RIGHT_DELIM') ? constant('RIGHT_DELIM') : null);?>
);
        var data = [
        ...
        placeholder.on('plothover', function (event, pos, item) {
            if(item) {
                ...
                $tooltip.css(<?php echo (defined('LEFT_DELIM') ? constant('LEFT_DELIM') : null);?>
top:pos.pageY + 10, left:pos.pageX + 10<?php echo (defined('RIGHT_DELIM') ? constant('RIGHT_DELIM') : null);?>
);
            } else {
                $tooltip.hide();
                previousPoint = null;
        ...
        var sales_charts = $('#sales-charts').css(<?php echo (defined('LEFT_DELIM') ? constant('LEFT_DELIM') : null);?>
'width':'100%' , 'height':'220px'<?php echo (defined('RIGHT_DELIM') ? constant('RIGHT_DELIM') : null);?>
);
        $.plot("#sales-charts", [
        ...
        $('#recent-box [data-rel="tooltip"]').tooltip(<?php echo (defined('LEFT_DELIM') ? constant('LEFT_DELIM') : null);?>
placement: tooltip_placement<?php echo (defined('RIGHT_DELIM') ? constant('RIGHT_DELIM') : null);?>
);
        ...
        $('.dialogs,.comments').ace_scroll(<?php echo (defined('LEFT_DELIM') ? constant('LEFT_DELIM') : null);?>
        ...
        $('#tasks').sortable(<?php echo (defined('LEFT_DELIM') ? constant('LEFT_DELIM') : null);?>
